...
return new class extends Migration
{
    ...
    {
        Schema::create('itens_documentos_interno', function (Blueprint $table) {

            $table->unsignedBigInteger('documento_interno_id'); // referência sem relação direta
    ...
    {
        Schema::dropIfExists('itens_documentos_interno');
    }
};
