...
<body>
    ...
    @foreach ($vias as $via)
        ...
        <div class="documento">
            ...
            <div class="section" style="min-height: 400px; padding: 10px; margin-top: 20px;">
                ...
                @foreach ($paginas as $i => $pagina)
                    <div class="page">
                        ...
                        <header class="section" style="width: 100%; position: relative; margin-bottom: 100px;">
                            ...
                            @if ($dadosPersonalizacaoFatura->mostrar_logo && $dadosPersonalizacaoFatura->logo)
                                <div style="border-bottom: 1px solid #069; width: 100%; margin-bottom: 10px;">
                                    ...
                                    <div
                                        style="display: block; float: right; width: 200px; text-align: right; margin-top: 20px;">
                                        <span
                                            style="font-size: 12pt; font-weight: bold;">{{ $documento->tipo_nome }}</span>
                                        <br>
                        ...
                        @if ($i === 0)
                            <div class="section">
                                ...
                                <table style="width: 100%; border-top: 2px solid #000;">
                                    <tr style="">
                                        <th style="border-bottom: 1px solid #000; text-align: left; margin: 3px;">Data
                                            de Emissão</th>
                                        <th style="border-bottom: 1px solid #000; text-align: left; margin: 3px;">
                                            Vencimento</th>
                                        <th style="border-bottom: 1px solid #000; text-align: left; margin: 3px;">
                                            Contribuinte</th>
                                        <th style="border-bottom: 1px solid #000; text-align: left; margin: 3px;">V/
                                            Ref.</th>
                                    </tr>
                                    <tr>
                                        <td>{{ \Carbon\Carbon::parse($documento->data_emissao)->format('Y-m-d') }}</td>
                                        <td>{{ \Carbon\Carbon::parse($documento->data_vencimento)->format('Y-m-d') }}
                                        </td>
                            ...
                            <div style="font-size: 10px; margin-top: -20px;">
                                <p><strong>Observações:</strong>
                                    {{ $documento->observacoes ?? 'Documento emitido para fins de Formação. Não tem validade fiscal.' }}
                                </p>
                            </div>
                            ...
                            @if ($documento->tipo_sigla === 'GT' || $documento->tipo_sigla === 'GR')
                                ...
                                <table width="100%" cellspacing="0" cellpadding="4"
                                    ...
                                    <tr>
                                        <td colspan="2"
                                            style="border-bottom: 1px solid #000; font-weight: bold; padding: 6px;">
                                            Dados de Transporte
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%" valign="top"
                                            style="border-right: 1px solid #000; padding: 6px;">
                                ...
                                <div style="width:100%; margin-top:10px; font-size:12px; overflow:visible;">
                                    ...
                                    <div style="float:left; width:45%; text-align:left; font-family: monospace;">
                                        <span
                                            style="display:block; text-align: center; white-space:nowrap; margin-bottom:8px;">
                                            _____________________________
                                        </span>
                                        <span
                                            style="display:block; text-align: center; font-family: sans-serif; margin-top:6px;">
                        ...
                        <div
                            ...
                            ">
                            <hr>
                            <span>FzBf-Processado por programa validado n. /AGT/2019</span><br>
                            <span>Página {{ $i + 1 }} / {{ $totalPaginasPorVia }}</span>
                        </div>
