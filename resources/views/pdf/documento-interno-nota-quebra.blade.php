...
{{-- DESCRIÇÃO --}}
<div class="descricao">
    O presente documento serve para registar a quebra/perda de produtos em stock,
    resultante de danos, extravio, vencimento ou outros motivos internos.
</div>
...
{{-- RODAPÉ --}}
{{-- <div class="rodape">
    Documento interno – Nota de Quebra<br>
